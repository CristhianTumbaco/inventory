...
function buildPurchasesStats(data) {
            ...
            <div class="col-lg-12 mb-2">
                <div class="card shadow border card-hover h-100">
                    <div class="card-body d-flex align-items-center gap-3 p-2">
                        ...
                        <div>
                            <div class="text-muted fw-bold h6 mb-1">Total Comprado</div>
            ...
            <div class="col-lg-12 mb-2">
                <div class="card shadow border card-hover h-100">
                    <div class="card-body d-flex align-items-center gap-3 p-2">
                        ...
                        <div>
                            <div class="text-muted fw-bold h6 mb-1">N° de Compras</div>
...
function buildPurchasesGraph(data) {
...
function buildPurchasesGraphSupplier(data) {
...
function buildPurchasesGraphProducts(data) {
  const categories = data.map(item => {
  ...
  const options = {
    ...
    title: {
      text: 'Productos más comprados (LB)',
      align: 'left',
    },
    colors: ['#1565C0'],
    plotOptions: {
...
function buildPurchasesGraphTaxes(data) {
  const options = {
    series: [
      Number(data.total),
      Number(data.taxes)
