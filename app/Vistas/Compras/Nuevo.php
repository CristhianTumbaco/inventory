...
<div class="row">
    <div class="d-flex user-select-none mb-3 col-12">
        ...
        <div class="ms-2">
            <div class="h4 fw-semibold">Registrar Compra</div>
            <h6 class="card-subtitle mb-2 text-body-secondary">Complete la siguiente información para registrar una nueva compra.</h6>
        </div>
    </div>
        ...
        <div class="card shadow w-100">
            ...
            <div class="card-body p-3">
                <div>
                    ...
                    <div class="mb-2">
                        <label class="form-label fw-bold">N° de Factura <b class="text-danger">*</b></label>
                        <input type="text" class="form-control rounded-0" id="invoice_number" placeholder="Ingrese el número de factura" />
                    </div>
                    <div class="mb-2">
                        <label class="form-label fw-bold">Fecha de Compra <b class="text-danger">*</b></label>
                        <input type="date" class="form-control rounded-0" value="<?php echo date('Y-m-d'); ?>" id="purchase_date" />
                    </div>
                    <hr>
            ...
            <div class="card-body p-4">
                <div class="d-flex flex-column flex-md-row align-items-md-center user-select-none">
                    ...
                    <div class="ms-auto fw-semibold">
                        <div class="money-wrapper w-md-auto">
                            ...
                            <input type="text" class="form-control form-control-lg fw-semibold money-input decimal-only" id="subtotal" placeholder="Subtotal de la compra" readonly disabled />
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex flex-column flex-md-row align-items-md-center user-select-none mt-2">
                    ...
                    <div class="ms-auto fw-semibold">
                        <div class="money-wrapper w-md-auto">
                            <span class="money-symbol">$</span>
                            <input type="text" class="form-control form-control-lg fw-semibold money-input decimal-only" value="" id="total" placeholder="Total de la compra" readonly disabled />
                        </div>
                    </div>
                </div>
                <div class="d-flex justify-content-end mt-3">
                    <button type="button" id="btncreatePurchase" class="btn btn-primary btn-lg mt-3 d-flex align-items-center btn-createPurchase">
