            ...
            <div class="mb-2">
                ...
                <select class="form-select" name="product" disabled>
                    ...
                    foreach ($products as $a) {
                        ...
                        if ($a->getId() == $data->getProduct_id()) {
                            echo ' selected';
                        }
                        echo '>' . $a->getName() . '</option>';
                    }
                    ?>
                </select>
            </div>
            <div class="mb-2">
                <label class="fw-bold">Nombre del subproducto</label>
                <input class="form-control" value="<?= $data->getName() ?>" name="name" placeholder="Ingrese el nombre" required />
            </div>
            <div class="mb-2">
                <label class="fw-bold">Descripción del subproducto</label>
                <input class="form-control" value="<?= $data->getDescription() ?>" name="description" placeholder="¿Alguna Observación?" />
            </div>
            <div class="mb-2">
                <label class="fw-bold">Estado del subproducto</label>
