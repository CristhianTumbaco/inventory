...
<div class="card shadow-lg w-50 m-auto">
    <div class="card-body p-4">
        ...
        <form action="<?= RUTA_WEB . "/" . $this->clase ?>/update" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-2">
                <label class="fw-bold">Nombre de la presentación</label>
                <input class="form-control" value="<?= $data->getName() ?>" name="name" placeholder="Ingrese el nombre" required />
            </div>
            <div class="mb-2">
                <label class="fw-bold">Referencia en libras</label>
                <input class="form-control decimal-only" value="<?= $data->getReference_weight_lb() ?>" name="reference_weight_lb" placeholder="0.00" />
            </div>
            <div class="mb-2">
                <label class="fw-bold">Descripción</label>
                <input class="form-control" value="<?= $data->getDescription() ?>" name="description" placeholder="¿Alguna Observación?" />
            </div>
            <div class="mb-2">
