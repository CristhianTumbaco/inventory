    ...
    <div class="card-body p-4">
        ...
        <form action="<?= RUTA_WEB . "/" . $this->clase ?>/save" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-2">
                ...
                <input class="form-control decimal-only" name="reference_weight_lb" placeholder="0.00" />
            </div>
            <div class="mb-2">
                <label class="fw-bold">Descripción</label>
                <input class="form-control" name="description" placeholder="¿Alguna Observación?" />
            </div>
