    ...
    <div class="card-body p-4">
        <div class="d-flex user-select-none mb-3">
            <div class="d-flex align-items-center justify-content-center">
                <span class="material-symbols-outlined text-dark h1">account_box</span>
            </div>
            <div class="ms-2">
                <div class="h4 fw-semibold">Informe de <?= $this->clase ?></div>
                <h6 class="card-subtitle mb-2 text-body-secondary">Gestione y administre los usuarios.</h6>
            </div>
            <div class="ms-auto">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <?php
                                if ($item->getRol() == 0) {
                                    echo '<span class="badge bg-dark">Administrador</span>';
                                } else {
