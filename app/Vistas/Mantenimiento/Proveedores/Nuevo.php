    ...
    <div class="card-body p-4">
        ...
        <form action="<?= RUTA_WEB . "/" . $this->clase ?>/save" method="POST" enctype="multipart/form-data">
            <div class="mb-2">
                ...
                <input class="form-control" name="identification" placeholder="Ingrese el nombre" />
            </div>
            <div class="mb-2">
            ...
            <div class="mb-2">
                ...
                <input class="form-control" name="phone" placeholder="Ingrese el nombre" />
            </div>
            <div class="mb-2">
                <label class="fw-bold">Correo del proveedor</label>
                <input type="email" class="form-control" name="email" placeholder="Ingrese el nombre" />
            </div>
            <div class="mb-2">
                <label class="fw-bold">Dirección del proveedor</label>
                <input class="form-control" name="address" placeholder="Ingrese el nombre" />
            </div>
